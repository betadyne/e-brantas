      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Daftar Tahanan</h1>
              <p className="text-gray-600">Kelola data tahanan narkoba</p>
            </div>
          </div>
        </div>
        ...
        <Card className="shadow-lg border-0">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-xl">Data Tahanan Narkoba</CardTitle>
                <CardDescription>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Nama Tersangka</TableHead>
                    <TableHead>LKN</TableHead>
                    <TableHead>Barang Bukti</TableHead>
                    <TableHead>SP-HAN</TableHead>
                    <TableHead>Pasal</TableHead>
                    <TableHead>Masa Tahanan</TableHead>
                    <TableHead>Sisa Hari</TableHead>
                    <TableHead>Penyidik</TableHead>
                  ...
                  {filteredTahanan.map((t, index) => {
                    ...
                    return (
                      <TableRow key={t.id}>
                        ...
                        <TableCell className="font-medium">{t.nama_tersangka}</TableCell>
                        <TableCell>{t.lkn ? new Date(t.lkn).toLocaleDateString('id-ID') : '-'}</TableCell>
                        <TableCell>{t.barang_bukti || '-'}</TableCell>
                        <TableCell>{new Date(t.sp_han).toLocaleDateString('id-ID')}</TableCell>
                        <TableCell>{t.pasal}</TableCell>
                        <TableCell>{t.masa_tahanan} Hari</TableCell>
                        <TableCell>
                        ...
                        <TableCell>{t.nama_penyidik}</TableCell>
                        <TableCell>
                          {t.keterangan && (
                        ...
                        <TableCell>
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <AlertDialog>
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  <AlertDialogTitle>Hapus Data Tahanan</AlertDialogTitle>
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent className="max-w-4xl">
            <DialogHeader>
              <DialogTitle>Edit Data Tahanan</DialogTitle>
              <DialogDescription>
            ...
            <div className="grid md:grid-cols-2 gap-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="edit_nama_tersangka">Nama Tersangka</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_lkn">LKN</Label>
                <Input
                  id="edit_lkn"
                  type="date"
                  value={editForm.lkn}
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_barang_bukti">Barang Bukti</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_sp_han">SP-HAN</Label>
                <Input
                  id="edit_sp_han"
                  type="date"
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-sm">Pasal</span>
                    <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_masa_tahanan">Masa Tahanan</Label>
                <div className="flex items-center gap-2">
                  <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="edit_nama_penyidik">Nama Penyidik</Label>
                <Input
